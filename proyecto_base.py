...
El descriptor de SIFT está basado en una normalización respecto a una orientación de referencia. Como esta orientación de referencia vamos a usar el ángulo del gradiente local dominante. Primero lo calcularemos para posteriormente normalizar su distribución.
